...
export function createDungeonState(options) {
  ...
  const dungeon = {
    ...
    dungeonTypeId: options.dungeonTypeId ?? "lost_civilization",
    ...
    eventTables: {
      ...
      guard_room: "tables/events/guard-room.json",
      armory_room: "tables/events/armory-room.json",
      barracks_room: "tables/events/barracks-room.json",
      library_room: "tables/events/library-room.json",
      noble_room: "tables/events/noble-room.json",
      storage_room: "tables/events/storage-room.json",
      shrine_room: "tables/events/shrine-room.json",
      throne_room: "tables/events/throne-room.json",
      crypt_room: "tables/events/crypt-room.json",
      crypt_corridor: "tables/events/crypt-corridor.json",
      vault_room: "tables/events/vault-room.json",
      ruin_room: "tables/events/ruin-room.json",
      ruin_corridor: "tables/events/ruin-corridor.json",
      flooded_room: "tables/events/flooded-room.json",
      flooded_corridor: "tables/events/flooded-corridor.json",
      occult_room: "tables/events/occult-room.json",
      occult_corridor: "tables/events/occult-corridor.json",
      cavern_chamber: "tables/events/cavern-chamber.json",
      cavern_passage: "tables/events/cavern-passage.json",
    },
